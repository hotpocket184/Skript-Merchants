...
public class ExprExperienceReward extends SimpleExpression<Boolean> {

    static {
        Skript.registerExpression(ExprExperienceReward.class, Boolean.class, ExpressionType.SIMPLE, "[the] experience reward of %merchantrecipes%");
    }
    ...
    protected @Nullable Boolean[] get(Event e) {
        ...
        for (MerchantRecipe recipe : recipes.getAll(e))
            rewards.add(recipe.hasExperienceReward());
    ...
    public String toString(@Nullable Event e, boolean debug) {
        return "experience reward of " + recipes.toString(e, debug);
    }
